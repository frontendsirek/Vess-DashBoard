...
export const MANAGEMENT_TABLE_HEAD_ROW_CLASS =
  'bg-vess-grey-100 text-[15px] font-normal leading-[18px] text-vess-grey-950'

/** Row dividers: 1px (device list and similar tables). */
export const MANAGEMENT_TABLE_BODY_DIVIDE_STANDARD_CLASS =
  'divide-y divide-vess-grey-100 bg-vess-grey-50 text-[15px] font-normal leading-[18px] text-vess-grey-950'

/** Row dividers: 2px (device test history). */
export const MANAGEMENT_TABLE_BODY_DIVIDE_HEAVY_CLASS =
  'divide-y-2 divide-vess-grey-100 bg-vess-grey-50 text-[15px] text-vess-grey-950'
